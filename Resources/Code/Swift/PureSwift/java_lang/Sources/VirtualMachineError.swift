...
open class VirtualMachineError: JavaError {
    ...
    public convenience init( arg0: String?, arg1: java_swift.Throwable? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/lang/VirtualMachineError", classCache: &VirtualMachineError.VirtualMachineErrorJNIClass, methodSig: "(Ljava/lang/String;Ljava/lang/Throwable;)V", methodCache: &VirtualMachineError.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( arg0: java_swift.Throwable? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/lang/VirtualMachineError", classCache: &VirtualMachineError.VirtualMachineErrorJNIClass, methodSig: "(Ljava/lang/Throwable;)V", methodCache: &VirtualMachineError.new_MethodID_4, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
