...
open class JavaError: java_swift.Throwable {
    ...
    public convenience init( arg0: String?, arg1: java_swift.Throwable?, arg2: Bool, arg3: Bool ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/lang/Error", classCache: &JavaError.JavaErrorJNIClass, methodSig: "(Ljava/lang/String;Ljava/lang/Throwable;ZZ)V", methodCache: &JavaError.new_MethodID_4, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( arg0: java_swift.Throwable? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/lang/Error", classCache: &JavaError.JavaErrorJNIClass, methodSig: "(Ljava/lang/Throwable;)V", methodCache: &JavaError.new_MethodID_5, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
