...
open class StringIndexOutOfBoundsException: IndexOutOfBoundsException {
    ...
    public convenience init( index: Int ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/lang/StringIndexOutOfBoundsException", classCache: &StringIndexOutOfBoundsException.StringIndexOutOfBoundsExceptionJNIClass, methodSig: "(I)V", methodCache: &StringIndexOutOfBoundsException.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( s: String? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/lang/StringIndexOutOfBoundsException", classCache: &StringIndexOutOfBoundsException.StringIndexOutOfBoundsExceptionJNIClass, methodSig: "(Ljava/lang/String;)V", methodCache: &StringIndexOutOfBoundsException.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
