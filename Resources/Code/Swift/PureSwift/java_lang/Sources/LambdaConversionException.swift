...
open class LambdaConversionException: java_swift.Exception {
    ...
    public convenience init() {
        ...
        let __object = JNIMethod.NewObject( className: "java/lang/invoke/LambdaConversionException", classCache: &LambdaConversionException.LambdaConversionExceptionJNIClass, methodSig: "()V", methodCache: &LambdaConversionException.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init( message: String? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/lang/invoke/LambdaConversionException", classCache: &LambdaConversionException.LambdaConversionExceptionJNIClass, methodSig: "(Ljava/lang/String;)V", methodCache: &LambdaConversionException.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( message: String?, cause: java_swift.Throwable?, enableSuppression: Bool, writableStackTrace: Bool ) {
        ...
        __args[0] = JNIType.toJava( value: message, locals: &__locals )
        __args[1] = JNIType.toJava( value: cause, locals: &__locals )
        __args[2] = jvalue( z: jboolean(enableSuppression ? JNI_TRUE : JNI_FALSE) )
        __args[3] = jvalue( z: jboolean(writableStackTrace ? JNI_TRUE : JNI_FALSE) )
        let __object = JNIMethod.NewObject( className: "java/lang/invoke/LambdaConversionException", classCache: &LambdaConversionException.LambdaConversionExceptionJNIClass, methodSig: "(Ljava/lang/String;Ljava/lang/Throwable;ZZ)V", methodCache: &LambdaConversionException.new_MethodID_4, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( cause: java_swift.Throwable? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/lang/invoke/LambdaConversionException", classCache: &LambdaConversionException.LambdaConversionExceptionJNIClass, methodSig: "(Ljava/lang/Throwable;)V", methodCache: &LambdaConversionException.new_MethodID_5, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
