...
open class InternalError: VirtualMachineError {
    ...
    public convenience init( message: String?, cause: java_swift.Throwable? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/lang/InternalError", classCache: &InternalError.InternalErrorJNIClass, methodSig: "(Ljava/lang/String;Ljava/lang/Throwable;)V", methodCache: &InternalError.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( cause: java_swift.Throwable? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/lang/InternalError", classCache: &InternalError.InternalErrorJNIClass, methodSig: "(Ljava/lang/Throwable;)V", methodCache: &InternalError.new_MethodID_4, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
