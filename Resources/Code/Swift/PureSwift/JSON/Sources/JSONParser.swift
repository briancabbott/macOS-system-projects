...
public extension JSON.Value {
    ...
    public init(string: Swift.String) throws {
        ...
        self = try JSON.Parser.parse(string)
    }
    
    /// Parses JSON from data.
    public init(data: Data) throws {
        
        self = try JSON.Parser.parse(data)
    }
}
...
extension JSON.Parser {
  ...
  public static func parse(_ buffer: UnsafeBufferPointer<UTF8.CodeUnit>, options: Option = []) throws -> JSON.Value {
...
extension JSON.Parser {
  ...
  public static func parse(_ data: Data, options: Option = []) throws -> JSON.Value {
  ...
  public static func parse(_ data: [UTF8.CodeUnit], options: Option = []) throws -> JSON.Value {
  ...
  public static func parse(_ string: String, options: Option = []) throws -> JSON.Value {
...
extension JSON.Parser {
   ...
   */
  mutating func parseValue() throws -> JSON.Value {
  ...
  mutating func parseObject() throws -> JSON.Value {
    ...
    var tempDict: JSON.Object = Dictionary(minimumCapacity: 6)
    var wasComma = false
  ...
  mutating func parseArray() throws -> JSON.Value {
  ...
  mutating func parseNumber() throws -> JSON.Value {
  ...
  func constructNumber(significand: UInt64, mantisa: UInt64?, exponent: UInt64?, divisor: Double, negative: Bool, negativeExponent: Bool) throws -> JSON.Value {
